<?php $__env->startSection('title','Bill Maxim'); ?>
	...
	<tbody>
		...
		<?php $__currentLoopData = $bookingDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			...
			<tr>
				...
				<td><?php echo e((!empty($Details->item_price)? '$'.$Details->item_price: '')); ?></td>

				<td>
					<?php if(!empty(totalPrice)): ?>
					<img src="/assets/img/bd_taka_icon.png" width="10px">
					<?php echo e($Details->item_price * $conversion_rate); ?>

					<?php endif; ?>
				</td>

				<td><?php echo e((!empty($totalPrice)? '$'.$totalPrice: '')); ?></td>

				<td><?php if(!empty(totalPrice)): ?>
					<img src="/assets/img/bd_taka_icon.png" width="10px">
					<?php echo e($totalPrice * $conversion_rate); ?>
		...
		<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>		
			<tr>
				<td colspan="<?php echo e($countTotalspan); ?>"> <center><b><?php echo e((1003 == $formatTypes)?'TOTAL QTY & VALUE':'Total'); ?></b></center></td>
			...
			<tr>
				...
				<!-- <td> 80</td> -->
				<td><?php echo e((!empty($totalUsdAmount)? '$'.$totalUsdAmount: '')); ?></td>
			</tr>
			<tr>
				<td colspan="8"><center><b>Total BDT</b></center></td>
				<td> <?php echo e($conversion_rate); ?></td>
				<td><img src="/assets/img/bd_taka_icon.png" width="10px"> <?php echo e((!empty($BDTandUSD)? $BDTandUSD: '')); ?></td>
			</tr>
			...
			<tr>
				<td>					
					<div style="text-align:;font-weight: bold;">
						...
						<span>1. TOTAL AMOUNT : USD : <?php echo e($amountInWordUsd); ?> <?php echo e((empty($amountInWordUsd))?'':'USD Only'); ?></span>

						<?php }else{?>

						<span>1. TOTAL AMOUNT : USD : <?php echo e($amountInWordUsd); ?> And <?php echo e($fractionInWordUSD); ?> Cents BDT Only</span>
			...
			<tr>
				<td>
					<div style="text-align:;font-weight: bold;">
						...
						<span>1. TOTAL AMOUNT : BDT : <?php echo e($amountInWordBD); ?> BDT Only</span>
						<?php }else{?>
						<span>1. TOTAL AMOUNT : BDT : <?php echo e($amountInWordBD); ?> And <?php echo e($fractionInWordBD); ?> Cents BDT Only</span>
						<?php }?>
					</div>
				</td>
			</tr>
