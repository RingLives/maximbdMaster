...
<div class="col-md-12">
  ...
  <form class="" action="<?php echo e(Route('booking_order_action')); ?>" role="form" method="POST" enctype="multipart/form-data">
    <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
    <input type="hidden" name="buyerDetails" value="<?php echo e($buyerDetails); ?>">
    <?php if($taskType == $general): ?>
      <input type="hidden" name="is_type" value="general">
    <?php elseif($taskType == $fsc): ?>
      ...
      <table class="table-striped" width="100%">
        ...
        <tbody>
          <tr>
            <td>
              <div class="form-group">
                <input type="text" name="orderDate" class="form-control" placeholder="Order Date" title="Order Date" value="<?php echo e(carbon\carbon::today()->format('d-m-Y')); ?>" readonly>
              </div>
            </td>
